...
function App() {
  ...
  return (
    <>
      <main className="flex flex-col justify-center items-start w-[100%] gap-5 h-[95vh] px-[10%] md:px-[0%] md:items-center">
      ...
      <footer className="h-[5vh] text-center">
        <p className="text-gray-300">© 2023 Jose Lara. Todos los derechos reservados.</p>
      </footer>
    </>
  )
}
